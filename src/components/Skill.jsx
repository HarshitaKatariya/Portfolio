...
// const Skill = () => {
//   return (
//     <div className="overflow-hidden w-full bg-transparent py-20" id="skill">
//       {/* Section Title */}
...
//       {/* Scrolling Skills */}
//       <div className="flex items-center space-x-5 m-5 animate-marquee">
//         {skills.concat(skills).map((skill, index) => (
//           <div
//             key={index}
//             className="border border-red-600 rounded-xl inline-flex items-center justify-center m-2 p-4 shadow-lg transition-transform transform hover:scale-110 hover:shadow-2xl"
//           >
//             <FontAwesomeIcon icon={skill.icon} className={`${skill.color} text-4xl mr-2`} />
